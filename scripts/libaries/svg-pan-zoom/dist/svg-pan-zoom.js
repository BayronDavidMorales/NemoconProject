...
module.exports = {
  enable: function(instance) {
    ...
    if (!styleEl) {
      ...
      style.textContent =
        ".svg-pan-zoom-control { cursor: hand; fill: black; fill-opacity: 0.333; } .svg-pan-zoom-control:hover { fill-opacity: 0.8; } .svg-pan-zoom-control-background { fill: white; fill-opacity: 0.5; } .svg-pan-zoom-control-background { fill-opacity: 0.8; }";
